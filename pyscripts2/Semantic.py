...
with open('speech.json', 'r') as f:
    speech_data = json.loads(f.read())

# print(speech_data)
prob_sim_sent = main(speech_data['question'] , speech_data['recording_content'])

# print(prob_sim_sent)
score = nums['hello'] * prob_sim_sent + nums[speech_data['emotion']]
print(score)
